...
while (true) {
const first_name = prompt("What is your name? ").trim();
if (first_name.length >= 2 && first_name.length <= 20) {
  userProfile.first_name = first_name;
  break;
} else {
  console.log("Your name should be between 2 and 20 characters.")
}
}

while (true) {
const last_name = prompt("What is your surname? ").trim();
if (last_name.length >= 2 && last_name.length <= 20) {
  userProfile.last_name = last_name;
  break;
} else {
  console.log("Your surname should be between 2 and 20 characters.")
}
}
...
if (age >= 18 && age <=99) {
  ...
  console.log("Please enter valid age (18-99).")
}
}
...
while (true) {
  min_age_interest = Number(prompt("What min age are you looking for? "));
if (min_age_interest >= 18 && min_age_interest <= 99) {
  userProfile.min_age_interest = min_age_interest;
  break;
} else {
  console.log("Has to be between 18 and 99.")
}
}

while (true) {
  max_age_interest = Number(prompt("What max age are you looking for? "));
if (max_age_interest >= 18 && max_age_interest <= 99 && max_age_interest > min_age_interest) {
  userProfile.max_age_interest = max_age_interest;
  break;
} else {
  console.log("Has to be more than minimum age. ")
}
}

while(true) {
  const gender = prompt("What is your gender (M, F or X?) ").toUpperCase();
if (gender === 'M' || gender === 'F' || gender === 'X') {
  userProfile.gender = gender;
  break;
} else {
  console.log("Please fill in your gender.")
}
}

while (true) {
const gender_interest = prompt("Who are you looking for? (M, F or X?) ").toUpperCase();
if (gender_interest === 'M' || gender_interest === 'F' || gender_interest === 'X') {
  userProfile.gender_interest = gender_interest;
  break;
} else {
  console.log("Please fill in the gender.")
}
}

while (true) {
const location = prompt("What is your location, city or rural? ").trim().toLowerCase();
if (location === 'city' || location === 'rural') {
  userProfile.location = location;
  break;
} else {
  console.log("Please fill in your location.")
}
}
